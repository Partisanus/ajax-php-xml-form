$(document).ready ( function () {
    $("#submit_registration").bind("click", function () {
        $.ajax ({
            ...
            success: function (data) {
                if(data == '5') {
                    //тут должна быть установка куков и перенаправление на нужную страницу, НО
                    //Проверки все работают и пользователь создается, но не получаем нужный ответ для переадресации
                    //точнее, насколько я понял ответ приходит в неправильном формате, как исправить не придумал...
    ...
    $("#submit_enter").bind("click", function () {
        $.ajax ({
            ...
            success: function (data) {
                if(data == '1') {
                    //тут же должна быть установка куков
                    window.location.href = "index.php";//если логин ипароль верны переадресует на нужную страницу
                }
                else{
